    ...
    <View className="flex-1 bg-primary-dark">
      ...
      <View className="flex-row items-center justify-between px-4 py-4">
        <View className="flex-row items-center">
          ...
          <Text className="text-primary-button text-xl font-bold">Privacy Policy</Text>
        </View>
      </View>

      {/* Content */}
      <ScrollView className="flex-1 px-4 pb-10 pt-5">
        <Text className="text-gray-200 text-base mb-4">
          Welcome to <Text className="font-bold text-primary-btnLight">Scribbly</Text>.
          Your privacy is very important to us. This Privacy Policy explains how
          Scribbly handles your data.
        </Text>
        ...
        <Text className="text-gray-300 mb-4">
          ...
          device. We do not collect, store, or share any of your personal data.
        </Text>
        ...
        <Text className="text-gray-300 mb-4">
          Scribbly does not require you to create an account or sign in.You'll have to secure your private notes by a 4 digit pin that is completely offline. Your
          content belongs 100% to you.
        </Text>

        {/* Permissions */}
        <Text className="text-gray-400 font-semibold mb-1">Permissions</Text>
        <Text className="text-gray-300 mb-4">
          We may request access to storage only for saving your notes. We do not
          access any other data on your device.
        </Text>

        {/* Sharing */}
        <Text className="text-gray-400 font-semibold mb-1">Sharing Notes</Text>
        <Text className="text-gray-300 mb-4">
        ...
        {/* Changes */}
        <Text className="text-gray-400 font-semibold mb-1">Policy Changes</Text>
        <Text className="text-gray-300 mb-4">
          If we ever make changes to this privacy policy, we'll update it right
          here in the app. No hidden terms, no nonsense.
        </Text>
